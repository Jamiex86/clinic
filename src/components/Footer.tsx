        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          ...
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center gap-2 mb-6">
              <div className="w-10 h-10 bg-white text-slate-900 flex items-center justify-center font-serif font-bold text-xl border border-yellow-500">
                ML
              </div>
              <span className="text-xl font-serif font-bold tracking-tighter">
                CLINIC<span className="text-yellow-500">.VIP</span>
              </span>
            </div>
            ...
            <div className="flex gap-4">
              {/* Instagram */}
              <a 
                href="https://www.instagram.com/mlclinic.vip/profilecard/?igsh=MW1hNmhqaHZ5bmd6eA" 
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:border-yellow-500 hover:text-yellow-500 transition-all hover:-translate-y-1"
              ...
              {/* TikTok (NEW) */}
              <a 
                href="https://www.tiktok.com/@mlclinic.vip?_t=ZN-8vl9lwSzD4I&_r=1" 
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full bg-slate-900 border border-slate-800 flex items-center justify-center hover:border-yellow-500 hover:text-yellow-500 transition-all hover:-translate-y-1"
                aria-label="TikTok"
